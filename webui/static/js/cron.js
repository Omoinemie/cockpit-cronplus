...
var CronUtil = (function () {
    ...
    function describeSpecial(s) {
        var map = {
            ...
            '@yearly': I18n.t('schedule.yearly'),
            '@annually': I18n.t('schedule.yearly'),
            '@monthly': I18n.t('schedule.monthly'),
            '@weekly': I18n.t('schedule.weekly'),
            '@daily': I18n.t('schedule.daily'),
            '@midnight': I18n.t('schedule.midnight'),
            '@hourly': I18n.t('schedule.hourly')
        };
        return map[s] || s;
    }
